...
t_noeud* creer_animal(int px, int py, int age, int energie, int gest)
{
	...
	nouvel_anim->animal = (t_animal*)malloc(sizeof(t_animal));
	if (nouvel_anim == NULL)
	{
	...
	init_animal(nouvel_anim->animal, px, py, age, energie, gest);
...
*/
void ajout_animal(t_liste* liste, int px, int py, int age, int energie, int gest)
{
